...
**归档/历史**：`docs/HANDBOOK.md`（总览与定案速查）· `docs/adr/`（**27 篇**决策历史）· `docs/chinese-mud-concerns.md`（中文问题全景 35 条）· `docs/engine-purity-audit.md`（2026-09-01 一次性审计快照，非现状）· `docs/engine-reservations.md`（引擎预留清单）。
