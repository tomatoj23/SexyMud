...
| `docs/adr/0001`–`0030` | 30 个架构决策（0016–0030 = MUD 转向与引擎定位；**0029 标签模型、0030 原型继承** = M3） | ✅ 权威 |
...
- 术语词典 / 文风指南 / 内容管线约定 / **30 个 ADR** 齐备；兽数据归 `beast/` 集合，获取走 sect `exchange` 贡献兑换
...
4. M4 ＝ 时间与调度（spec/04 §2–§4，战斗前夜）——**下一个里程碑**
