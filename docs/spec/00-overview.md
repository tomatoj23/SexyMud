...
| **时间／调度（＝ M4，T4–T7）** | ⏳ **设计已定案、部分未实现**（19 条，见 `spec/04` §2–§4 与 ADR-0031–0034；T1／T2／T3 已关，余 #23–#26） |
